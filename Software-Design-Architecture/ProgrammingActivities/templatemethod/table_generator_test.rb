...
class TableGeneratorTest < Minitest::Test
  ...
  def test_CSVTableGenerator
    ...
    assert_equal \
      ...
      CSVTableGenerator.new(@headerStudents, @dataStudents).generate
  end
  ...
  def test_HTMLTableGenerator
    ...
    assert_equal \
      ...
      "<tr><td>718</td><td>Manjula Nahasapeemapetilon</td><td>53</td>" +
      "<td>72</td><td>88</td><td>71</td></tr>\n" +
      "</table>\n",
      HTMLTableGenerator.new(@headerStudents, @dataStudents).generate
  end
  ...
  def test_AsciiDocTableGenerator
    assert_equal \
      ...
      "|99|15|34\n" +
      "|==========\n",
      AsciiDocTableGenerator.new(@headerNums, @dataNums).generate
    assert_equal \
      "[options=\"header\"]\n" +
      "|==========\n" +
      "|id|name|grade1|grade2|grade3|average\n" +
      ...
      "|718|Manjula Nahasapeemapetilon|53|72|88|71\n" +
      "|==========\n",
      AsciiDocTableGenerator.new(@headerStudents, @dataStudents).generate
  end
