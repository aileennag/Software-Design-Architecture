...
class JakenponTest < Minitest::Test
  ...
  def test_dsl_2
    ...
    show Spock + Lizard
    #------------------
    assert_equal "Lizard poisons Spock (winner Lizard)\n" \
                 "Result = Lizard\n", \
                 @out.string
  end
  ...
  def test_dsl_3
    ...
    show Spock - Lizard
    #------------------
    assert_equal "Lizard poisons Spock (loser Spock)\n" \
                 "Result = Spock\n", \
                 @out.string
  end
  ...
  def test_dsl_5
    ...
    show Spock + (Lizard + Rock)
    #---------------------------
    assert_equal "Rock crushes Lizard (winner Rock)\n" \
  ...
  def test_dsl_6
    ...
    #--------------------------------------------
    assert_equal "Paper covers Rock (winner Paper)\n" \
  ...
  def test_dsl_7
    ...
    show Rock - Paper - Scissors - Lizard - Spock
    #--------------------------------------------
    assert_equal "Paper covers Rock (loser Rock)\n" \
  ...
  def test_dsl_9
    ...
    #---------------------------------------------
    assert_equal "Paper disproves Spock (winner Paper)\n" \
